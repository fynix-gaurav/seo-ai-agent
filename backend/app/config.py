...
# Use the most cost-effective models suitable for development and testing.
DEV_OPENAI_MODEL_GROUPER = "gpt-3.5-turbo"
...
PROD_ANTHROPIC_STRATEGIST_MODEL = "claude-3-opus-20240229"